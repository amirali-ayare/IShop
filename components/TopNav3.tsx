...
function TopNav3() {
    ...
    const topNavData = [
        ...
        {
            icon: <i className='bx bx-detail text-white'></i>,
            title: "تکمیل",
            class: "rounded-2xl p-3 flex shadow-lg shadow-slate-200 bg-green-500 text-slate-300 text-xl",
            textClass: "text-xs mt-2 text-green-500"
        },
    ]
